...
namespace Raminagrobis.DAL
{
    public class Supplier_DAL
    {
        ...
        public Supplier_DAL(string company, string civility, string surname, string name, string email, string address) 
                => (Company, Civility, Surname, Name, Email, Address) = (company, civility, surname, name, email, address);

        public Supplier_DAL(int id, string company, string civility, string surname, string name, string email, string address)
